(function ($) {
  ...
  if ($("#traffic-chart").length) {
    var chart = new Chartist.Line(
      "#traffic-chart",
      {
        ...
        series: [
          [
            13000, 18000, 35000, 18000, 25000, 26000, 22000, 20000, 18000,
            35000, 18000, 25000,
          ],
          [
            15000, 23000, 15000, 30000, 20000, 31000, 15000, 15000, 23000,
            15000, 30000, 20000,
          ],
          [
            25000, 15000, 38000, 25500, 15000, 22500, 30000, 25000, 15000,
            38000, 25500, 15000,
          ],
        ],
      },
  ...
  $("#sparklinedash, #sparklinedash6, #sparklinedash11").sparkline(
    [0, 5, 6, 10, 9, 12, 4, 9],
    {
      type: "bar",
      height: "30",
  ...
  $("#sparklinedash2, #sparklinedash7, #sparklinedash12").sparkline(
    [0, 5, 6, 10, 9, 12, 4, 9],
    {
      type: "bar",
      height: "30",
  ...
  $("#sparklinedash3, #sparklinedash8, #sparklinedash13").sparkline(
    [0, 5, 6, 10, 9, 12, 4, 9],
    {
      type: "bar",
      height: "30",
  ...
  $("#sparklinedash4, #sparklinedash9, #sparklinedash14").sparkline(
    [0, 5, 6, 10, 9, 12, 4, 9],
    {
      type: "bar",
      height: "30",
  ...
  $("#sparklinedash5, #sparklinedash10, #sparklinedash15").sparkline(
    [0, 5, 6, 10, 9, 12, 4, 9],
    {
      type: "bar",
      height: "30",
